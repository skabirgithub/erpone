...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('type', $otherpaytype, null, ['class' => 'form-control select amount_type', 'required' => 'required'])); ?>
...
<?php /**PATH /home/vivahkhq/office.vivape.co/resources/views/otherpayment/create.blade.php ENDPATH**/ ?>