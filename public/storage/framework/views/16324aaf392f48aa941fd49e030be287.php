...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('chart_account_id', $chart_accounts,'', array('class' => 'form-control select','required'=>'required'))); ?>
...
<?php /**PATH /home/vivahkhq/office.vivape.co/resources/views/bankAccount/create.blade.php ENDPATH**/ ?>