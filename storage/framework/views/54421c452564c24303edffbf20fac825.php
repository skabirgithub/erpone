...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('chart_account_id', $chart_accounts,null, array('class' => 'form-control select','required'=>'required'))); ?>
...
<?php /**PATH C:\laragon\www\erpone\resources\views/bankAccount/edit.blade.php ENDPATH**/ ?>