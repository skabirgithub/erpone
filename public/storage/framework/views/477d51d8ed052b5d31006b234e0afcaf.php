    ...
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create plan')): ?>
            <?php if(isset($admin_payment_setting) && !empty($admin_payment_setting)): ?>
                <?php if($admin_payment_setting['is_manually_payment_enabled'] == 'on' || $admin_payment_setting['is_bank_transfer_enabled'] == 'on'
                ...
                <div class="card price-card price-1 wow animate__fadeInUp" data-wow-delay="0.2s" style="
                   ...
                   ">
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <h1 class="mb-4 f-w-600 "><?php echo e((isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '$')); ?><?php echo e(number_format($plan->price)); ?>
                        ...
                        <div class="row ">
                            <div class="col-6">
                                <ul class="list-unstyled my-5">
                                    ...
                                    <li class="white-sapce-nowrap"><span class="theme-avtar"><i class="text-primary ti ti-circle-plus"></i></span><?php echo e(($plan->storage_limit==-1)?__('Unlimited'):$plan->storage_limit); ?> <?php echo e(__('MB')); ?>  <?php echo e(__('Storage')); ?></li>
                                </ul>
                            </div>
                            <div class="col-6">
                                <ul class="list-unstyled my-5">
                                    ...
                                    <li class="white-sapce-nowrap"><span class="theme-avtar"><i class="text-primary ti ti-circle-plus"></i></span><?php echo e(($plan->chatgpt==1)?__('Enable'):__('Disable')); ?> <?php echo e(__('Chat GPT')); ?></li>
                        ...
                        <?php if(\Auth::user()->type =='super admin'): ?>
                            <div class="col-4">
                                <a title="<?php echo e(__('Edit Plan')); ?>" href="#" class="btn btn-primary btn-icon m-1" data-url="<?php echo e(route('plans.edit',$plan->id)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Plan')); ?>" data-size="lg" data-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>">
                        ...
                        <?php if(\Auth::user()->type =='company' && \Auth::user()->plan == $plan->id): ?>
                            <p class="display-total-time text-dark mb-0">
                                <?php echo e(__('Plan Expired : ')); ?> <?php echo e(!empty(\Auth::user()->plan_expire_date) ? \Auth::user()->dateFormat(\Auth::user()->plan_expire_date):'lifetime'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\office.vivape.co\resources\views/plan/index.blade.php ENDPATH**/ ?>