...
<?php $__env->startSection('content'); ?>
    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
               href="<?php echo e(route('report.monthly.pos')); ?>"
               onclick="window.location.href = '<?php echo e(route('report.monthly.pos')); ?>'" role="tab"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " >
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['report.daily.pos'], 'method' => 'GET', 'id' => 'daily_pos_report_submit'])); ?>
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="<?php echo e(route('report.daily.pos')); ?>" class="btn btn-sm btn-danger" data-toggle="tooltip"
    ...
    <div id="printableArea">
        ...
        <div class="row mt-0">
            <div class="col">
                <input type="hidden" value="<?php echo e($filter['warehouse'].' '.__('Daily Pos').' '.'Report of'.' '.$filter['startDate'].' to '.$filter['endDate']); ?>" id="filename">
                <div class="card p-4 mb-4">
                    <h7 class="report-text gray-text mb-0"><?php echo e(__('Report')); ?> :</h7>
                    <h6 class="report-text mb-0"><?php echo e(__('Daily Pos Report')); ?></h6>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vivahkhq/office.vivape.co/resources/views/report/daily_pos.blade.php ENDPATH**/ ?>