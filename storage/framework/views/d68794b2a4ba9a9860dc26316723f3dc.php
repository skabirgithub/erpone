...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php echo e(Form::open(['route' => ['balance.sheet.print', 'horizontal']])); ?>
                                ...
                                <div class="border-start border-end">
                                        ...
                                        <?php if($accounts != [] && $type != 'Assets'): ?>
                                            <div class="account-main-inner py-2">
                                                ...
                                                <div
                                                    ...
                                                    <h6 class="fw-bold mb-0 text-end me-3"><?php echo e(\Auth::user()->priceFormat($total)); ?></h6>
                                                </div>
                                                <?php
                                                    if ($type != 'Assets') {
                                                        $totalAmount += $total;
                                    ...
                                    <?php if($totalAmount != 0): ?>
                                        <div
                                            ...
                                            <h6 class="fw-bold mb-0 text-end me-3"><?php echo e(\Auth::user()->priceFormat($totalAmount)); ?></h6>
                                        </div>
                                    <?php endif; ?>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vivahkhq/office.vivape.co/resources/views/report/balance_sheet_horizontal.blade.php ENDPATH**/ ?>