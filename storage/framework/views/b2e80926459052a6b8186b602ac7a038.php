...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::number('amount', !empty($billDue)?$billDue->getDue():0, array('class' => 'form-control','required'=>'required','step'=>'0.01'))); ?>
...
<?php /**PATH C:\laragon\www\erpone\resources\views/debitNote/create.blade.php ENDPATH**/ ?>